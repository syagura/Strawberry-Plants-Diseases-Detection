...
const char* ssid     = "TUMBUR"; // CHANGE HERE
const char* password = "SIHOMBING17"; // CHANGE HERE

const char* websockets_server_host = "192.168.0.129"; //CHANGE HERE
...
esp_err_t init_camera() {
  ...
  s->set_exposure_ctrl(s, true); // Enable exposure control
  // s->set_exposure_val(s, 100); // Adjust exposure value
